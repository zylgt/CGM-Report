<template>
  <div id="report" ref="report">
    ...
    <div class="reports-box">
      <div class="report-main-title-infos">
        ...
        <div class="report-main-date">
          {{ info.start_date }}
          <div class="repart-main-dirver-box">
            <span class="repart-main-dirver"></span>
          </div>
          {{ info.end_date }}({{ info.total_day }})
        </div>
      </div>
      <div v-if="!empty">
        <!-- 基本信息 -->
        <div class="report-main-base-info report-main" ref="test">
          ...
          <div class="report-base-user">
            <div class="report-base-user-item">
              ...
              <div class="report-base-user-value">
            ...
            <div class="report-base-user-item">
              ...
              <div class="report-base-user-value">
                {{ info.diabetes_type ? info.diabetes_type : "--" }}
              </div>
            </div>
            <div class="report-base-user-item">
              <div class="report-base-user-label">Course of the Disease：</div>
              <div class="report-base-user-value">
                {{ info.diabetes_year ? info.diabetes_year : "--" }}
              </div>
            </div>
            <div class="report-base-user-item">
              <div class="report-base-user-label">Target Range：</div>
              <div class="report-base-user-value">
                {{ info.glucose_range_lower_limit }}-{{
                  info.glucose_range_lupper_limit
                }}{{ unit }}
              </div>
            </div>
          </div>
          ...
          <div class="report-data-sources">
            ...
            <div class="report-base-user-item">
              <div class="report-base-user-value">
                {{ info.phone_model ? info.phone_model : "--" }}
              </div>
            </div>
            <div class="report-base-user-item">
        ...
        <div class="report-main-data-tir-box">
          <div class="report-main-data-tir report-main">
            ...
            <div class="report-main-data-list" v-if="unit == 'mg/dL'">
              <div class="report-main-data-label">
                <div class="report-main-data-label-text">
                  Mean Glucose (MG)：
                </div>
                <div class="report-main-data-label-tip">Target＜118 mg/dL</div>
              </div>
            ...
            <div class="report-main-data-list">
              <div class="report-main-data-label">
                ...
                <div class="report-main-data-label-tip">Target＜6%</div>
              </div>
              <div class="report-main-data-val">
                {{ resultDay >= 10 ? bgInfo.GMI + "%" : "Not Enough Data" }}
              </div>
            </div>
            <div class="report-main-data-list">
              <div class="report-main-data-label">
          ...
          <div class="report-main-data-tir report-main">
            ...
            <div class="report-module-tips report-module-tips-only">
              The higher the percentage of time within the TIR, the better the
              blood sugar control.
            </div>
            <div class="tir-box">
              <TIR :dataList="tir" />
        ...
        <div class="report-main-agp report-main">
          <div class="report-module-title">
            <div class="report-module-title-border"></div>
            <div class="report-module-title-text">
              Ambulatory Glucose Profile (AGP)
            </div>
          </div>
          <div class="report-module-tips">
            <div class="report-module-tips">
              The median glucose curve is within the target range, and the
              flatter it is, the better the blood glucose stability. The 25%-75%
              range (the dark blue area in the chart) and the 5%-95% range (the
              light blue area in the chart) both display daytime blood glucose
              fluctuations. A wider range indicates greater fluctuation in blood
              glucose during the corresponding period.
            </div>
          </div>
          <div class="agp-box">
        ...
        <div class="report-main-day report-main">
          ...
          <div class="report-module-tips">
            <div class="report-module-tips">
              Daily blood glucose shows the daily fluctuations over the 15-day
              period.
            </div>
          </div>
      ...
      <div class="report-main-params">
        ...
        <div class="report-main-params-item">
          1. Mean Glucose (MG): The average of glucose level during CGM wearing
          period. It is used to assess the effectiveness of diabetes management
          strategies. <br />
          2.Glucose Management Indicator (GMI): GMI has a strong correlation
          with HbA1c when wearing CGM for long time. It is used to evaluate
          overall blood sugar standards. <br />
          3.Coefficient of Variation (CV): It is calculated as the standard
          deviation divided by the mean glucose level，it is used to reflects
          blood glucose fluctuations. <br />
          4.Time In Range (TIR): The time or percentage of time when glucose
          levels are within the target range.<br />
          5.Time Above Range (TAR): The time or percentage of time when glucose
          levels are above the target range. <br />
          6.Time Below Range (TBR): The time or percentage of time when glucose
          levels are below the target range.<br />
        </div>
        <div class="report-main-params-title">References</div>
        <div class="report-main-params-item">
          Continuous glucose monitoring and metrics for clinical trials: an
    ...
    <div
      class="reports-box"
      :style="{ height: pageTwoResultHeight * 2375 + 'px' }"
    >
      <div class="report-main-title-infos">
        <img src="~@/assets/image/report-logo.png" alt="" class="report-logo" />
        ...
        <div class="report-main">
          ...
          <div class="event-type" ref="eventTypes">
            <div class="event-type-item">
              <img
                src="~@/assets/image/event-icon0.png"
                alt=""
                class="event-icon"
              />
            ...
            <div class="event-type-item">
              <img
                src="~@/assets/image/event-icon1.png"
                alt=""
                class="event-icon"
              />
            ...
            <div class="event-type-item">
              <img
                src="~@/assets/image/event-icon2.png"
                alt=""
                class="event-icon"
              />
            ...
            <div class="event-type-item">
              <img
                src="~@/assets/image/event-icon3.png"
                alt=""
                class="event-icon"
              />
            ...
            <div class="event-type-item">
              <img
                src="~@/assets/image/event-icon4.png"
                alt=""
                class="event-icon"
              />
            ...
            <div class="event-type-item">
              <img
                src="~@/assets/image/event-icon5.png"
                alt=""
                class="event-icon"
              />
            ...
            <div class="event-type-item">
              <img
                src="~@/assets/image/event-icon6.png"
                alt=""
                class="event-icon"
              />
    ...
    <div v-if="pdfDayData.length > 0 && pdfDayData[0].length > 0">
      <div
        class="reports-box"
        v-for="(item, indexs) in pdfDayData"
        :key="item.height"
        :style="{ height: pageThreePage * 2375 + 'px' }"
      >
        <div class="report-main-title-infos breakPage">
          <img
            src="~@/assets/image/report-logo.png"
            alt=""
            class="report-logo"
          />
          <div class="report-main-title">Daily Blood Glucose</div>
        ...
        <!-- 参数解释 -->
        <div
          class="report-main-params"
          v-if="indexs == pdfDayData.length - 1"
          style="margin-top: 30px"
        >
          <div class="report-main-params-title">Parameter Explanation</div>
          <div class="report-main-params-item">
            1. Mean Glucose (MG): The average of glucose level during CGM
            wearing period. It is used to assess the effectiveness of diabetes
            ...
            4.Time In Range (TIR): The time or percentage of time when glucose
            levels are within the target range.<br />
            5.Time Above Range (TAR): The time or percentage of time when
            glucose levels are above the target range. <br />
            6.Time Below Range (TBR): The time or percentage of time when
            glucose levels are below the target range.<br />
          </div>
          <div class="report-main-params-title">References</div>
          <div class="report-main-params-item">
            Continuous glucose monitoring and metrics for clinical trials: an
  ...
  methods: {
          ...
          if (response.code == 1000) {
            ...
            if (response.data.datas.length > 0) {
              ...
              if (response.data.glucose_unit == 0) {
                target = [
                  GlucoseUtils.mgdlToMmol(
                    response.data.glucose_range_lower_limit
                  ),
                  GlucoseUtils.mgdlToMmol(
                    response.data.glucose_range_lupper_limit
                  ),
                ];
              } else {
                target = [
              ...
              let s =
                response.data.start_date.indexOf("年") == -1
                  ? this.getZoneTime(
                      response.data.timezone,
                      response.data.start_date
                    )
                  : this.getZoneTime(response.data.timezone, s_t);
              let e =
                response.data.end_date.indexOf("年") == -1
                  ? this.getZoneTime(
                      response.data.timezone,
                      response.data.end_date
                    )
                  : this.getZoneTime(response.data.timezone, e_t);
              let s_date = s.setHours(0, 0, 0) / 1000;
              let e_date = e.setHours(23, 59, 59) / 1000;
              if (arrayData.length > 0) {
                this.handelTemplateDay(
                  this.handleData(arrayData, s_date, e_date),
                  this.handelEventDay(response.data.events),
                  this.handelWarningDay(response.data.bg_events)
                );
              }
            }
          } else {
    ...
    handelAgp(data) {
      ...
      function momentAgp05(val) {
        val = _.compact(val);
        return AGPUtils.calculateYValue(val)
          ? AGPUtils.calculateYValue(val).p05
          : AGPUtils.calculateYValue(val);
      }
      function momentAgp25(val) {
        val = _.compact(val);
        return AGPUtils.calculateYValue(val)
          ? AGPUtils.calculateYValue(val).p25
          : AGPUtils.calculateYValue(val);
      }
      function momentAgp50(val) {
        val = _.compact(val);
        return AGPUtils.calculateYValue(val)
          ? AGPUtils.calculateYValue(val).p50
          : AGPUtils.calculateYValue(val);
      }
      function momentAgp75(val) {
        val = _.compact(val);
        return AGPUtils.calculateYValue(val)
          ? AGPUtils.calculateYValue(val).p75
          : AGPUtils.calculateYValue(val);
      }
      function momentAgp95(val) {
        val = _.compact(val);
        return AGPUtils.calculateYValue(val)
          ? AGPUtils.calculateYValue(val).p95
          : AGPUtils.calculateYValue(val);
      }
    ...
    handelTir(data) {
      ...
      let result = TIRUtils.getTIRResult(
        _.compact(v_data),
        tirTarget[1],
        tirTarget[0]
      );
    ...
    handelDay(data, events, bg_events) {
      ...
      let max =
        _.maxBy(DdatArray, "Value").Value > 540
          ? 540
          : _.maxBy(DdatArray, "Value").Value;
      ...
      singleDay.forEach((item, index) => {
        ...
        let eventArray =
          events[formatDate(item[0].DataTs * 1000, "YYYY-mm-dd")];
        let bgEventsArray = bg_events
          ? bg_events[formatDate(item[0].DataTs * 1000, "YYYY-mm-dd")]
          : [];
        ...
        let result = TIRUtils.getTIRResult(
          _.compact(originValue),
          tirTarget[1],
          tirTarget[0]
        )
          ? TIRUtils.getTIRResult(
              _.compact(originValue),
              tirTarget[1],
              tirTarget[0]
            )
      ...
      this.resultDay = _.filter(dayList, function (o) {
        return o.resultValue.length > 0;
      }).length;
    },
    // pdf分页
    padPage(dayList) {
      ...
      dayList.forEach((item, index) => {
        if (pageTwoHeight - item.height > 0) {
          ...
          this.pageThreePage =
            pdfDayData.length > 0 ? pdfDayData[0][0].pdfPage : 1;
    ...
    handelBg(data) {
      ...
      let bgInfo = GlucoseUtils.calculateMeanCvGmi(
        _.compact(_.map(BdatArray, "Value"))
      );
      ...
      let filteredArray = BdatArray.filter(
        (item) => item.Value >= 36 && item.Value <= 540
      );
      bgInfo.effective = _.round(
        (filteredArray.length / originList.length) * 100,
        1
      );
    ...
    handelEventDay(datas) {
      ...
      data.forEach((item, index) => {
        ...
        let zeroTs =
          this.getZoneTime(this.$timezone, key).setHours(0, 0, 0) / 1000;
    ...
    handel(dataArray) {
      ...
      this.bgInfo.effective = _.round(
        (filteredArray.length / dataArray.length) * 100,
        1
      );
    },
    // 获取地址栏参数
